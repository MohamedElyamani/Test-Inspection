...
class MenuComponent {
  ...
  // TODO: not done
  private _destroy = () => {
    this.element.removeEventListener('click', MenuComponent.globalClickHandler);
	}
  ...
  public static createInstances = (selector: string) => {
	...
	private static globalClickHandler = (e: MouseEvent) => {
  ...
  public static initGlobalHandlers = () => {
    document.removeEventListener('click', MenuComponent.globalClickHandler);
    // Dropdown handler
    document.addEventListener('click', MenuComponent.globalClickHandler);
